    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-3 sm:p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-10">
        <div className="flex flex-col items-center gap-2">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-xl shadow-lg p-2 border-2 border-sky-200 flex items-center justify-center">
            <span className="text-lg">🍽️</span>
          </div>
          <p className="text-sky-600 text-xs">FastServ</p>
        </div>
      </div>
    </div>
  );
